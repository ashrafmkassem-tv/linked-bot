...
DEFAULT_L1 = ['AAOI', 'ALB', 'AMAT', 'AMD', 'AMZN', 'AQB', 'AQN', 'ASML', 'ASTS', 'AVAV', 'AVGO', 'BB', 'BBAI', 'BIP', 'BITF', 'CCJ', 'CEVA', 'CIEN', 'COHR', 'CRWV', 'DELL', 'DNN', 'DRAM', 'DVLT', 'EBM', 'EME', 'ENSC', 'ETN', 'EU', 'FCX', 'FN', 'FTS', 'HIVE', 'HUBB', 'HUT', 'IONQ', 'IPWR', 'IREN', 'LAC', 'LEU', 'LITE', 'LUNR', 'MCHP', 'MRVL', 'MSFT', 'MSS', 'MU', 'NBIS', 'NDM', 'NNE', 'NOK', 'NOW', 'NVDA', 'OKLO', 'ONDS', 'ORCL', 'PLTR', 'POET', 'PYPL', 'QBTS', 'QUBT', 'RAM', 'RCAT', 'RGTI', 'RIG', 'SIMO', 'SMCI', 'SMR', 'SNDU', 'SNDK', 'SOFI', 'SPCE', 'SQNS', 'STX', 'SWKS', 'TE', 'TSLA', 'TSM', 'UBER', 'USAR', 'UUUU', 'VERI', 'VRT', 'VTIX', 'WDC', 'ZETA', 'ANET', 'MOD', 'CLS', 'PSTG', 'NTAP', 'MCHP', 'ON', 'NXPI', 'ARM', 'QCOM', 'NNE', 'UEC', 'FN', 'CIEN', 'LUMN', 'RGTI', 'RKLB', 'ASTS', 'LUNR', 'PL', 'BKSY', 'RDW', 'HON', 'IBM', 'GOOGL']
